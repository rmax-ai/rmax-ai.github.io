...
### [System Prompts Forensics](/research/)
Analyzing how contemporary AI tools structure authority and constraints in system prompts.
...
### [Constrained Agent Harness](https://github.com/rmax-ai/constrained-agent-harness)
Reference harness for running coding agents as bounded, verifiable search over repository states.
...
<!-- CONTACT -->
## Contact
Interested in collaborating? Email at [hello@rmax.ai](mailto:hello@rmax.ai).
